...
class UsersController extends Controller
{
    ...
    {
        $verifyData = \Cache::get('verificationCode_' . $request->verification_key);
        ...
        $data = $miniApp->getUtils()->codeToSession($request->code);
        ...
        \Cache::forget('verificationCode_' . $request->verification_key);
