...
@if (($active_users ?? collect())->isNotEmpty())
    <div class="card mt-4">
...
@if (($links ?? collect())->isNotEmpty())
    <div class="card mt-4">
        <div class="card-body pt-2">
            <div class="text-center mt-1 mb-0 text-muted">资源推荐</div>
            <hr class="mt-2 mb-3">
            @foreach ($links as $link)
                <a class="d-flex mt-1 text-decoration-none" href="{{ $link->link }}" target="_blank" rel="noopener noreferrer">
                    <div class="media-body">
